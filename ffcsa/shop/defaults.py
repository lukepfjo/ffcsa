...
register_setting(
    ...
    default=("SHOP_CARD_TYPES", "SHOP_CATEGORY_USE_FEATURED_IMAGE",
             ...
             "SHOP_USE_RELATED_PRODUCTS", "SHOP_USE_UPSELL_PRODUCTS"),
    append=True,
)
...
register_setting(
    ...
    editable=False,
    default="ffcsa.shop.checkout.default_billship_handler",
)
...
register_setting(
    ...
    description="Dotted package path and class name of the function "
                ...
                "function ``ffcsa.shop.utils.set_tax``.",
    editable=False,
    default="ffcsa.shop.checkout.default_tax_handler",
)
...
register_setting(
    ...
    editable=False,
    default="ffcsa.shop.checkout.default_order_handler",
)
...
register_setting(
    ...
    editable=False,
    default="ffcsa.shop.checkout.default_payment_handler",
)
