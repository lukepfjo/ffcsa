...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sku', ffcsa.shop.fields.SKUField(max_length=20, verbose_name='SKU')),
                ('description', models.CharField(max_length=2000, verbose_name='Description')),
                ('quantity', models.IntegerField(default=0, verbose_name='Quantity')),
                ('unit_price', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), max_digits=10, null=True, verbose_name='Unit price')),
                ('total_price', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, default=Decimal('0'), max_digits=10, null=True, verbose_name='Total price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_min', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Minimum price')),
                ('price_max', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Maximum price')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_deduct', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Reduce by amount')),
                ('discount_percent', ffcsa.shop.fields.PercentageField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='Reduce by percent')),
                ('discount_exact', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Reduce to amount')),
                ...
                ('code', ffcsa.shop.fields.DiscountCodeField(max_length=20, unique=True, verbose_name='Code')),
                ('min_purchase', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Minimum total purchase')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_total', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Shipping total')),
                ('tax_type', models.CharField(blank=True, max_length=50, verbose_name='Tax type')),
                ('tax_total', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Tax total')),
                ('item_total', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Item total')),
                ('discount_code', ffcsa.shop.fields.DiscountCodeField(blank=True, max_length=20, verbose_name='Discount code')),
                ('discount_total', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Discount total')),
                ('total', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Order total')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', mezzanine.core.fields.RichTextField(verbose_name='Content')),
                ('unit_price', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Unit price')),
                ('sale_id', models.IntegerField(null=True)),
                ('sale_price', ffcsa.shop.fields.MoneyField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Sale price')),
                ...
                ('sku', ffcsa.shop.fields.SKUField(blank=True, max_length=20, null=True, verbose_name='SKU')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', ffcsa.shop.fields.OptionField(max_length=50, null=True, verbose_name='Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option1', ffcsa.shop.fields.OptionField(max_length=50, null=True, verbose_name='Size')),
                ('option2', ffcsa.shop.fields.OptionField(max_length=50, null=True, verbose_name='Colour')),
